 ...
 *
 */
public class TCPROSHeader extends HashMap<String, String> implements  TCPROSMessage {
	...
	public TCPROSHeader(byte[] byteArray) throws IOException {
		LittleEndianInputStream inputStream = new LittleEndianInputStream(byteArray);
		int amountSize = 0;
